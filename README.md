...
### Windows
You can download prebuilt Windows binary from [Releases tab](https://github.com/AyuGram/AyuGramDesktop/releases).
### Linux
Sorry, ~Gram is not available on any Linux yet:(
### MacOS
Sorry, ~Gram is not available on MacOS yet:(
